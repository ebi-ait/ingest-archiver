...
class TestHcaSubmission(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.project_json = make_ingest_entity(self.test_type, self.project_schema_type, self.test_id1, self.test_uuid1)
        self.biomaterial_json = \
            make_ingest_entity(self.test_type, self.biomaterial_schema_type, self.test_id2, self.test_uuid2)
    ...
    def test_added_entity_is_contained_in_submission(self):
        ...
        self.assertTrue(self.submission.contains_entity_by_uuid(self.test_type, self.test_uuid1))
        self.assertTrue(self.submission.get_entity(self.test_type, self.test_id1))
    ...
    def test_added_entity_is_equal_to_entity_returned_from_submission(self):
        # When
        returned_entity = self.submission.get_entity(self.test_type, self.test_id1)
        # Then
    ...
    def test_added_entity_is_equal_to_entity_returned_from_hca_submission_by_uuid(self):
        # When
        returned_entity = self.submission.get_entity_by_uuid(self.test_type, self.test_uuid1)
        # Then
        self.assertEqual(self.test_project, returned_entity)
    ...
    def test_duplication_entity_with_differing_content_is_ignored(self):
        ...
        duplicate_test_case = make_ingest_entity(self.test_type, self.project_schema_type, self.test_id1, ignored_uuid)
        # When
